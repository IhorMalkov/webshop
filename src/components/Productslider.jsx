                    ...
                    <SwiperSlide key={slide.id} className="flex">
                        <div className="flex flex-col items-center text-center p-4 max-w-[300px] w-full">
                            ...
                            <div className="flex gap-[60px]">
                                <button className="p-2 bg-blue-600 text-white rounded-full">Add to Cart<span></span></button>
                                <button className="p-2 bg-blue-500 text-white rounded-full">Learn more<span></span></button>
                            </div>
                        </div>
                    </SwiperSlide>
                ))}
